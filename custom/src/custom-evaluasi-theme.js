...
/**
 * `CustomEvaluasiTheme`
 * `CustomEvaluasiTheme based on modern flex design system`
 ...
 * @element custom-evaluasi-theme
 */
class CustomEvaluasiTheme extends PolarisFlexTheme {
  //styles function
  static get styles() {
    return [
      super.styles,
...
customElements.define(CustomEvaluasiTheme.tag, CustomEvaluasiTheme);
export { CustomEvaluasiTheme };
